...
const PERMISSIONS_MAP = {
  ...
  "invoice.create":     ["director","manager","billing_agent","accountant"],
  "invoice.edit":       ["director","manager","billing_agent","accountant"],
  "invoice.validate":   ["director","manager","accountant"],
  "invoice.cancel":     ["director","accountant"],
  "cash.read":          ["super_admin","director","manager","cashier","accountant"],
  "cash.collect":       ["cashier","manager","director","accountant"],
  "cash.expense":       ["cashier","manager","director","accountant"],
  "cash.close":         ["cashier","manager","director","accountant"],
  "cash.adjust":        ["director","accountant"],
  ...
  "stock.inventory":    ["warehouse_agent","manager","director","accountant"],
  "stock.adjust":       ["director","accountant"],
  "credit.read":        ["super_admin","director","manager","billing_agent","accountant"],
  "credit.create":      ["billing_agent","manager","director","accountant"],
  "credit.approve":     ["manager","director","accountant"],
  "credit.payment":     ["cashier","manager","director","accountant"],
  ...
  "accounting.validate":["director","accountant"],
  "order.read":         ["super_admin","director","manager","sales_agent","warehouse_agent","accountant"],
  "order.create":       ["sales_agent","manager","director","accountant"],
  "order.validate":     ["manager","director","accountant"],
  "order.cancel":       ["director","accountant"],
  "delivery.read":      ["super_admin","director","manager","delivery_agent","accountant"],
  "delivery.update":    ["delivery_agent","manager","director"],
  "report.read":        ["super_admin","director","manager","accountant"],
  "report.export":      ["super_admin","director","manager","accountant"],
  "audit.read":         ["super_admin","director","manager","accountant"],
  "direction.read":     ["super_admin","director","manager","accountant"],
