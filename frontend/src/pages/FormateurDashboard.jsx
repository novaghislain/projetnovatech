...
const FormateurDashboard = () => {
  ...
  try {
    return (
                ...
                {courses.map(course => (
                  <div key={course.id} style={{ background: '#fff', borderRadius: '16px', padding: '1.5rem', boxShadow: '0 4px 20px rgba(0,0,0,0.03)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap' }}>
                    ...
                    <div style={{ display: 'flex', gap: '0.75rem' }}>
                      {/* L'admin gère désormais la création et modification des formations. */}
                      {/* Le formateur a uniquement la possibilité de gérer le contenu via l'onglet "Contenu des Cours". */}
                    </div>
                  </div>
                ))}
              </div>
      ...
      {/* Le formateur ne peut plus créer/modifier de formation, cette modale a été retirée */}
